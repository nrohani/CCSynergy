...
def runapp(i,n1,n2,n3,batch,lr,part):
    ...
    f = open("/nfs/research/petsalaki/users/rzgar/Outputs/EXP_CV2_"+str(FeatureName[i])+".txt", "a")
    rmse_mean=0
    sp_mean=0
    pcc_mean=0
    ...
    for train_index, test_index in kf.split(UniqList):
        ...
        cb_check = ModelCheckpoint(('/nfs/research/petsalaki/users/rzgar/Outputs/DNN_EXPCV2_'+str(part)+'_'+str(FeatureName[i])+'_Loewe'), verbose=1, monitor='val_loss',save_best_only=True, mode='auto')
        ...
        CNN_model = tf.keras.models.load_model('/nfs/research/petsalaki/users/rzgar/Outputs/DNN_EXPCV2_'+str(part)+'_'+str(FeatureName[i])+'_Loewe')
...
#    np.save('/nfs/research/petsalaki/users/rzgar/CV1_EXP_Pre_'+str(FeatureName[i])+'.npy', prenew)	
#
#    np.save('/nfs/research/petsalaki/users/rzgar/CV1_EXP_Real_'+str(FeatureName[i])+'.npy', realnew)	
    outFinal.to_csv('/nfs/research/petsalaki/users/rzgar/Result_CV2_EXP_'+str(FeatureName[i])+'.csv')
